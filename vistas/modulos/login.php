    ...
    <div class="body1">
        <div class="contenedor">
            ...
            <div class="registro">
                <header>
                    <div class="logo">
                        <img src="images/logoappark.png" alt="">
                    </div>
                ...
                <div class="contenidoLogin">
                    <h2>Ingresar</h2>
                    <form method="post">
                    <input type="text" minlength="4" maxlength="20" title="ingrese entre (4 y 15) caracteres" name="ingUsuario" value="" placeholder="Usuario" class="form-control" required>
                    <input type="password" minlength="4" maxlength="12" title="ingrese entre (6 y 12) caracteres" name="ingPassword" value="" placeholder="Contraseña" class="form-control" required>
                        ...
                        <p> ¿Olvido su contraseña? haga click -><a href="recuperar">Recuperar Contraseña</a></p>
                        <?php
